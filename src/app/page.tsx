...
const PythonIcon = () => (
    <svg 
        ...
        xmlns="http://www.w3.org/2000/svg"
    >
        <path d="M14.232 2.221a4.994 4.994 0 00-4.994 4.995v2.23h4.462v2.229H7.012a2.766 2.766 0 01-2.766-2.766V4.453a2.766 2.766 0 012.766-2.766h9.453a2.23 2.23 0 012.23 2.23v.306h-2.23v-.306c0-.129-.105-.233-.233-.233h-6.988z" fill="#3776ab"/>
        <path d="M9.768 21.779a4.994 4.994 0 004.994-4.995v-2.23h-4.462V12.33h7.188a2.766 2.766 0 012.766 2.766v4.456a2.766 2.766 0 01-2.766 2.766H5.244a2.23 2.23 0 01-2.23-2.23v-.307h2.23v.307c0 .129.105.233.233.233h6.988z" fill="#ffda48"/>
    </svg>
);
